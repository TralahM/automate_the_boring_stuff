...
BLOG_TITLE = "TralahTek"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://tralahm.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://tralahm.github.io/"
BLOG_EMAIL = "musyoki.tralah@students.jkuat.ac.ke"
BLOG_DESCRIPTION = "Speaking of issues as i think them"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/posts', 'My Articles', 'fa fa-book'),
        ('/archive.html', 'Archives', 'fa fa-folder-open'),
        ('/categories/index.html', 'Tags', 'fa fa-tags'),
        ('/rss.xml', 'RSS', 'fa fa-rss'),
        ('/index.html', 'About me', 'fa fa-home'),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://TralahM.github.io" rel="nofollow">Nikola</a>         {license}'
